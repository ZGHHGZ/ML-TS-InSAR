...
overwrite=0
data_path=/home/jovyan/iscepredata/ppp/crop
proc_dir=/home/jovyan/iscepredata/ppp/merged
...
# getting the merged extend
cd /home/jovyan/iscepredata/ppp/merged/geom_reference
python crop_rdr.py -b '36.727 36.773 117.952 118.003' > $proc_dir/crop_log.txt
...
command_baseline=`grep warp $proc_dir/crop_log.txt`
command=`grep gdal_translate $proc_dir/crop_log.txt`
echo $command
