...
def cmdLineParse():
   ...
   parser.add_argument('-dfac', '--downfac', dest='down_sample', type=str, required=False, default='3', help='Lon/Lat downsample factor used when mapping GEO-coordiantes to RDR')
   parser.add_argument('-nd', '--nodata', dest='nodata', type=str, required=False, default='0', help='Lon/Lat no-data value')
   parser.add_argument('-lat', '--lat', dest='latfile', type=str, required=False, default='lat_01.rdr', help='Lat filename')
   parser.add_argument('-lon', '--lon', dest='lonfile', type=str, required=False, default='lon_01.rdr', help='Lon filename')
