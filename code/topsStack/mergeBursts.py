...
def multilook(infile, outname=None, alks=5, rlks=15, multilook_tool="isce", no_data=None):
    ...
    width=size[4]
    height=size[5]
    lines = open(infile+'.vrt').readlines()
    lines[6]='            <SrcRect xOff="0" yOff="0" xSize=" '+width+' " ySize=" '+height+' "/>\n'
    lines[7]='            <SrcRect xOff="0" yOff="0" xSize=" '+width+' " ySize=" '+height+' "/>\n'
    open(infile+'.vrt','w').writelines(lines)
    '''
    ########################################################################################################
